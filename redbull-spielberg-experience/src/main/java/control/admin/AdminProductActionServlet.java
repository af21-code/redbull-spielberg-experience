...
public class AdminProductActionServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            if (!q.isEmpty())
                redir.append("&q=").append(url(q));
            if (!categoryId.isEmpty())
                redir.append("&categoryId=").append(url(categoryId));
            if (!onlyInactive.isEmpty())
                redir.append("&onlyInactive=").append(url(onlyInactive));
            ...
            if (!page.isEmpty())
                redir.append("&page=").append(url(page));
            if (!pageSize.isEmpty())
                redir.append("&pageSize=").append(url(pageSize));
            if (!sort.isEmpty())
                redir.append("&sort=").append(url(sort));
            if (!dir.isEmpty())
                redir.append("&dir=").append(url(dir));
