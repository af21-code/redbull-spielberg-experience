...
public interface CartDAO {
    ...
    void upsertItem(int userId, int productId, Integer slotId, int quantity) throws Exception;

    // NEW: salva anche i dettagli prenotazione se presenti (null = non aggiornare)
    void upsertItem(int userId, int productId, Integer slotId, int quantity,
