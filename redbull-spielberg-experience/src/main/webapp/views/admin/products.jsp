                ...
                <div class="admin-bg">
                  <div class="admin-shell">
                    ...
                    <section class="admin-content">
                      ...
                      <!-- Filtri -->
                      <form class="card filters-panel" method="get" action="<%=ctx%>/admin/products">
                        <div class="filters filters-container">
                          <div class="search-bar-container search-container-grow">
                            ...
                            <select name="categoryId" class="status-select">
                          ...
                          <div class="search-bar-container date-container"
                            ...
                            <label class="checkbox-inline"
                              ...
                              <span style="font-size: 0.95rem;">Solo inattivi</span>
                            </label>
                          </div>
                        </div>

                        <div class="filters filters-container" style="margin-top: 12px;">
                          <div class="search-bar-container date-container">
                            <select name="pageSize">
                              <option value="12" <%=sel(12, pageSize) %>>12 righe</option>
                              <option value="24" <%=sel(24, pageSize) %>>24 righe</option>
                              <option value="50" <%=sel(50, pageSize) %>>50 righe</option>
                            </select>
                          </div>
                          ...
                          <a class="btn outline reset-btn" href="<%=ctx%>/admin/products">↺</a>
                        </div>
                      </form>
                            ...
                            <tr>
                              <th style="width:40%">
                                <a href="<%=ctx%>/admin/products?<%=baseQuery%>&sort=name&dir=<%= esc("name".equals(sort)?toggledir(dir):"asc") %>"
                                  style="color: inherit; text-decoration: none; display: flex; align-items: center; gap:
                                  4px;">
