  ...
  <div class="login-wrap">
    <div class="login-card">
      ...
      <form class="login-form" id="login-form" action="${pageContext.request.contextPath}/login" method="post" novalidate>
        ...
        <input class="input" id="login_email" type="email" name="email" placeholder="MaxVerstappen@example.com" required autocomplete="email"/>
        <div class="error-msg" aria-live="polite"></div>

        <label for="login_password">Password</label>
        <input class="input" id="login_password" type="password" name="password" placeholder="••••••••" required autocomplete="current-password"/>
        <div class="error-msg" aria-live="polite"></div>
      ...
      <%
        Object em = request.getAttribute("errorMessage");
        if (em != null) {
      %>
        <div class="form-error"><%= esc(em) %></div>
      <% } %>
