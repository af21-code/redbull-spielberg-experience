...
<head>
  <meta charset="UTF-8" />
  <title>404 - Pagina non trovata | RedBull Spielberg Experience</title>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .card{
      width:min(680px, 92vw); padding:28px 24px; border-radius:20px;
    ...
    h1{font-size:64px; letter-spacing:1.2px; margin:12px 0 0}
    .subtitle{font:600 15px/1.4 Arial, sans-serif; color:#d9e2ef; margin:6px 0 18px}
    .code{font-size:120px; line-height:1; margin:8px 0 6px; color:var(--rb-gold); text-shadow:0 8px 24px rgba(0,0,0,.35)}
    .msg{font:600 15px/1.6 Arial, sans-serif; color:#cfd6e1; margin:0 auto 18px; max-width:520px}
    ...
    @media (max-width:480px){ h1{font-size:44px} .code{font-size:86px} }
  </style>
</head>
<body>
  <div class="card">
    ...
    <p class="subtitle">We missed the apex on this one.</p>
    <p class="msg">
      La pagina che stai cercando non esiste oppure è stata spostata.
      Torna ai box e riparti dalla home.
    </p>
