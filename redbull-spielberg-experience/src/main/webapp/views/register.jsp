  ...
  <div class="register-wrap">
    <div class="register-card">
      ...
      <form class="register-form" id="register-form" action="${pageContext.request.contextPath}/register" method="post" novalidate>
        ...
        <input class="input" id="reg_password" type="password" name="password" required autocomplete="new-password"/>
        <div class="error-msg" aria-live="polite"></div>

        <label for="reg_confirm">Conferma Password</label>
        <input class="input" id="reg_confirm" type="password" name="confirmPassword" required autocomplete="new-password"/>
        <div class="error-msg" aria-live="polite"></div>
