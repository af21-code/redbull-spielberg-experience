            ...
            <% String ctx=request.getContextPath(); String cssVer=(String) request.getAttribute("cssVersion"); String
                ...
                <SlotVM>) request.getAttribute("slotsVm");
                    ...
                    List<VehicleVM> vehiclesVm = (List<VehicleVM>) request.getAttribute("vehiclesVm");
                            ...
                            if (heroImg == null || heroImg.isBlank()) heroImg = ctx +
                            "/images/experience-hero-fallback.jpg";
                                ...
                                <% if (productId==null) { %>
                                    <section class="booking-shell">
                                        <div class="card" style="padding:20px">
                                            <p>Prodotto non trovato. <a href="<%=ctx%>/shop" class="btn">Torna allo
                                                    shop</a></p>
                                        </div>
                                    </section>
                                                ...
                                                <div class="col-left">
                                                    ...
                                                    <div class="booking-step card" data-step="1">
                                                        <header class="card-header">
                                                            ...
                                                            <h3 class="card-title">Seleziona data e orario <span
                                                                    style="color:#e74c3c">*</span></h3>
                                                            <small class="muted"
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div id="dateForm" class="booking-filter">
                                                                <input type="hidden" name="productId"
                                                                    value="<%= productId %>">
                                                                <label class="date-label">Scegli dal calendario
                                                                    (opzionale)
                                                            ...
                                                            <div class="date-section">
                                                                <h4 class="section-subtitle">Prossime date disponibili
                                                                </h4>
                                                                <p class="section-note">Tocca una data qui sotto o
                                                                    scegli dal calendario: aggiorniamo
                                                                    gli
                                                                    orari in automatico.</p>
                                                                <div id="avail" class="date-grid" aria-live="polite">
                                                                    Caricamento…</div>
                                                            </div>
                                                            ...
                                                            <fieldset class="section">
                                                                ...
                                                                <div class="section-head">
                                                                    <h3>Orari disponibili per il <span
                                                                ...
                                                                <div class="slot-grid">
                                                                    <% if (selectedDate==null) { %>
                                                                        <div class="empty">Seleziona una data per vedere
                                                                            gli orari disponibili.</div>
                                                                        <% } else if (slotsVm !=null &&
                                                                            !slotsVm.isEmpty()) { boolean
                                                                            firstRequiredSet=false; for (SlotVM s :
                                                                            slotsVm) { boolean isDisabled=s.isSoldOut();
                                                                            boolean setRequired=!isDisabled &&
                                                                            !firstRequiredSet; if (setRequired)
                                                                            firstRequiredSet=true; String
                                                                            lbl=s.getLabel()==null ? "" : s.getLabel();
                                                                            String timePart=lbl, remPart="" ; int
                                                                            dotIdx=lbl.indexOf("·"); if (dotIdx> 0)
                                                                            timePart = lbl.substring(0,
                                                                            dotIdx).trim();
                                                                            int postiIdx = lbl.lastIndexOf("posti");
                                                                            if (postiIdx >= 0) {
                                                                            String after = lbl.substring(postiIdx +
                                                                            "posti".length()).trim();
                                                                            StringBuilder num = new StringBuilder();
                                                                            for (int i = 0; i < after.length(); i++) {
                                                                                char c=after.charAt(i); if
                                                                                (Character.isDigit(c)) num.append(c);
                                                                                else break; } remPart=num.toString(); }
                                                                                %>
                                                                                <label
                                                                                    class="slot-pill <%= (isDisabled?"disabled":"") %>"
                                                                                    data-time="<%= timePart %>"
                                                                                        data-rem="<%= remPart %>">
                                                                                            <input type="radio"
                                                                                                name="slotId"
                                                            ...
                                                            <fieldset class="section">
                                                                ...
                                                                <div class="vehicle-grid">
                                                                    <% if (vehiclesVm !=null && !vehiclesVm.isEmpty()) {
                                                                        for (VehicleVM v : vehiclesVm) { %>
                                                                        <label
                                                                            class="vehicle-card <%= (v.isFeatured() ? "featured" : "" ) %>">
                                                                            <input type="radio" name="vehicleChoice"
                                                                                value="<%= v.getCode() %>"
                                                                                <%=v.isChecked() ? "checked" : "" %> >
                                                                            <span class="veh-inner"
                                                                                style="display:block">
                                                                                <% if (v.isFeatured()) { %>
                                                                                    <span class="ribbon"
                                                                                        style="display:block">Consigliata</span>
                                                                                    <% } %>
                                                                                        <img src="<%= v.getImg() %>"
                                                                                            alt="<%= v.getLabel() %>"
                                                                        ...
                                                                        <% } } else { %>
                                                                            <div class="empty">Nessun veicolo
                                                                                configurato.</div>
                                                                            <% } %>
                                                                </div>
                                                            </fieldset>
                                                    ...
                                                    <form class="booking-form" id="addToCartForm" method="post"
                                                        action="<%=ctx%>/cart/add" novalidate>
                                                        <input type="hidden" name="productId" value="<%= productId %>">
                                                        <input type="hidden" name="quantity" value="1">
                                                        <input type="hidden" name="slotId" id="slotId-hidden" value="">
                                                        <input type="hidden" name="eventDate"
                                                            value="<%= (selectedDate==null? "" : selectedDate.toString()) %>">
                                                        <input type="hidden" name="vehicleCode" id="veh-hidden"
                                                            value="<%= defaultVehicleCode %>">
                                                        ...
                                                        <div class="booking-step card" data-step="3">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="form-grid two-1">
                                                                    ...
                                                                    <label>Numero #
                                                                        <select class="select-lg" name="driverNumber"
                                                                            aria-label="Numero pilota">
                                                                            <option value="">—</option>
                                                                            <% for (int n=1; n <=99; n++) { %>
                                                                                <option value="<%= n %>">
                                                                                    <%= n %>
                                                            ...
                                                            <div class="sidebar-body">
                                                                ...
                                                                <div class="sidebar-cta">
                                                                    <button id="finalSubmitBtn"
                                                                        ...
                                                                        form="addToCartForm" <%=disableAddToCart
                                                                        ? "disabled" : "" %>>
                                                                        Aggiungi al carrello
                                                                    </button>
                                                                    <a class="btn secondary btn-sm"
                                                                        href="<%=ctx%>/shop">Torna allo shop</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
